<template>
    <div id="icons" class="flex justify-center w-full relative">
        <svg width="213" height="282" viewBox="0 0 213 282" fill="none" xmlns="http://www.w3.org/2000/svg" class="relative">
            ...
            <rect x="73.1077" width="140.377" height="140.377" rx="16" transform="rotate(7 73.1077 0)" fill="#C0F7DE" class="hover:cursor-pointer" @click.prevent="clickVue" />
            <g clip-path="url(#clip1_303_188)" class="hover:cursor-pointer" @click.prevent="clickVue" >
                <path d="M177.79 29.1222L202.472 32.1528L127.717 130.868L79.0628 17L126.267 22.7959L137.741 49.2236L154.96 26.319L177.79 29.1222Z" fill="#41B883"/>
                <path d="M79.0628 17L127.717 130.868L202.472 32.1528L177.79 29.1222L132.937 88.3511L103.436 19.9927L79.0628 17Z" fill="#41B883"/>
                <path d="M103.436 19.9927L132.899 88.6592L177.79 29.1222L154.96 26.319L137.741 49.2236L126.267 22.7959L103.436 19.9927Z" fill="#35495E"/>
            </g>
            <defs>
                <clipPath id="clip0_303_188">
                    <rect width="110" height="110" fill="white" transform="translate(17.0732 155.281) rotate(-9)" class="hover:cursor-pointer"/>
                </clipPath>
                <clipPath id="clip1_303_188">
                    <rect width="124.336" height="107.186" fill="white" transform="translate(79.0628 17) rotate(7)"/>
                </clipPath>
            </defs>
        </svg>
        <div
...
const menuToggles = ref<Array<boolean>>([false, false]);
...
const handleOutsideClick = (event: MouseEvent) => {
    const tooltip = document.getElementById('icons');
