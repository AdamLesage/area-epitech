    ...
    <div class="bg-home !h-full relative overflow-hidden">
        ...
        <nav class="flex items-center w-full justify-between px-8 py-4 fixed bg-home z-10">
            ...
            <div class="w-full flex gap-12 items-center justify-center text-home-text">
                ...
                <h1 class="text-xl font-bold tracking-wide mb-4 md:mb-0 cursor-pointer hover:underline decoration-2" @click="scrollToHowItWorks">How it Works</h1>
        ...
        <div id="about-us" class="flex flex-col items-center">
            ...
            <!-- Who's -->
            <section class="w-full flex justify-center flex-col gap-8 items-center mt-16">
        ...
        <div id="how-it-works" class="flex flex-col items-center">
            ...
            <button
                class="mt-8 w-48 h-12 bg-home-div text-white rounded-lg hover:cursor-pointer hover:bg-home-hover border-2 border-solid border-home-light z-[2]"
            ...
            <transition name="fade">
                <div v-if="showDetails" class="mt-16 p-6 bg-home-div text-white rounded-lg max-w-4xl shadow-lg z-[2]">
        ...
        <div id="services" class="flex flex-col items-center">
            ...
            <div class="flex gap-16 flex-wrap w-full justify-center">
                ...
                <div
                    ...
                    :key="service.name"
                    class="flex flex-col items-center p-4 rounded-md w-[20rem] h-48 justify-between z-[2]"
                    ...
                    <span class="text-lg font-medium text-white">{{ service.name.charAt(0).toUpperCase() + service.name.slice(1) }}</span>
        ...
        <div id="reviews" class="flex flex-col items-center justify-center mt-12 mb-80">
            <section class="flex justify-center gap-4 items-center h-[360px]">
                ...
                <div
                    class="flex flex-col items-center p-4 gap-4 rounded-lg justify-between bg-home-div w-full mt-32 z-[2]">
